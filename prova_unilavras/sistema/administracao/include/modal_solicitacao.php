...
<div class="modal fade" id="modal_solicitacao" tabindex="-1" role="dialog" aria-labelledby="Modal Solicitação" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="id_form_modal_solicitacao" data-toggle="validator">
            <div class="form-row">
            ...
            <div class="form-row ">
                ...
                <div class="input-group">
                    ...
                    <button class="btn btn-success" type="button" data-toggle="modal" data-target="#modal_setor_adm"><i class="fa fa-plus" aria-hidden="true"></i></button>
                    </div>
                ...
                <div>
                    ...
                    <div class="input-group-append">
                        <button class="btn btn-success" type="button" data-toggle="modal" data-target="#modal_curso_adm"><i class="fa fa-plus" aria-hidden="true"></i></button>
                    </div>
                    </div>
                </div>  
                </div>       
